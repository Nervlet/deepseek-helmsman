...
Play DOOM as an overlay in DeepSeek Helmsman. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
deepseek-helmsman --extension ./examples/extensions/doom-overlay
```
...
- Original overlay integration work that inspired this example
