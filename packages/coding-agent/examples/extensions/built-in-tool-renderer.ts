 ...
 *
 * Usage:
 *   deepseek-helmsman -e ./built-in-tool-renderer.ts
 */

import type { BashToolDetails, EditToolDetails, ExtensionAPI, ReadToolDetails } from "@deepseek-helmsman/coding-agent";
import { createBashTool, createEditTool, createReadTool, createWriteTool } from "@deepseek-helmsman/coding-agent";
