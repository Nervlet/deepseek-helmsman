...
import { complete, type Message } from "@deepseek-helmsman/ai";
import type { ExtensionAPI, SessionEntry } from "@deepseek-helmsman/coding-agent";
import { BorderedLoader, convertToLlm, serializeConversation } from "@deepseek-helmsman/coding-agent";
