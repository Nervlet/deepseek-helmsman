 ...
 * - Routing tool calls to remote systems (e.g., a remote SSH bridge)
 ...
 *
 * Usage:
 *   deepseek-helmsman -e ./tool-override.ts
 */

import type { TextContent } from "@deepseek-helmsman/ai";
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "@deepseek-helmsman/coding-agent";
