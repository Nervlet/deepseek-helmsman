...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@deepseek-helmsman/coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@deepseek-helmsman/tui";
