    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="deepseek-helmsman-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="deepseek-helmsman-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'deepseek-helmsman-share:v1:sidebar-width';
