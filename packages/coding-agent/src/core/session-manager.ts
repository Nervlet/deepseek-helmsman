import { type AgentMessage, uuidv7 } from "@deepseek-helmsman/agent-core";
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, undefined/false if DeepSeek Helmsman-generated (backward compatible) */
	fromHook?: boolean;
}
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, false if DeepSeek Helmsman-generated */
	fromHook?: boolean;
}
 ...
 * Encodes cwd into a safe directory name under ~/.deepseek-helmsman/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.deepseek-helmsman/agent/sessions/<encoded-cwd>/).
	 */
