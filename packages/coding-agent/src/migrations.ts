...
const MIGRATION_GUIDE_URL =
	"https://github.com/Nervlet/deepseek-helmsman/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL =
	"https://github.com/Nervlet/deepseek-helmsman/blob/main/packages/coding-agent/docs/extensions.md";
...
/**
 * Migrate sessions from legacy agent-root *.jsonl files to proper session directories.
 *
 ...
 *
 * See: https://github.com/Nervlet/deepseek-helmsman/issues/320
 */
 ...
 * Note: tools/ may contain fd/rg binaries extracted by DeepSeek Helmsman, so only warn if it has other files.
 */
