...
import { Container, Image, Spacer, Text } from "@deepseek-helmsman/tui";
...
export class DeepSeekHelmsmanAnnouncementComponent extends Container {
	constructor() {
		super();

		this.addChild(new DynamicBorder((text) => theme.fg("accent", text)));
		this.addChild(new Text(theme.bold(theme.fg("accent", "DeepSeek Helmsman")), 1, 0));
		this.addChild(new Spacer(1));
		this.addChild(new Text(theme.fg("muted", "A DeepSeek-focused coding agent fork."), 1, 0));
		this.addChild(new Spacer(1));
