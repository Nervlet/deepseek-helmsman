> DeepSeek Helmsman can create prompt templates. Ask it to build one for your workflow.
...
DeepSeek Helmsman loads prompt templates from:

- Global: `~/.deepseek-helmsman/agent/prompts/*.md`
- Project: `.deepseek-helmsman/prompts/*.md`
- Packages: `prompts/` directories or package manifest entries in `package.json`
