...
DeepSeek Helmsman runs on Android via [Termux](https://termux.dev/), a terminal emulator and Linux environment for Android.
...
Create `~/.deepseek-helmsman/agent/AGENTS.md` to help the agent understand the Termux environment:
