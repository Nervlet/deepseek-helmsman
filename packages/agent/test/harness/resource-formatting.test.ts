...
describe("resource formatting helpers", () => {
	it("formats skill invocations with additional instructions", () => {
		const skill = {
			...
			filePath: "/project/.deepseek-helmsman/skills/inspect/SKILL.md",
		};

		expect(formatSkillInvocation(skill, "Check errors.")).toBe(
			'<skill name="inspect" location="/project/.deepseek-helmsman/skills/inspect/SKILL.md">\nReferences are relative to /project/.deepseek-helmsman/skills/inspect.\n\nUse inspection tools.\n</skill>\n\nCheck errors.',
		);
	});
